        ...
        <div className='flex flex-col bg-slate-100 text-black'>
            ...
            <div className='w-28 sm:w-80 h-[calc(100vh-62px)] relative py-12 border border-black'>
                <div className='w-[50%] sm:w-[80%] absolute right-0'>
                    ...
                    <Link href={'/admin/categories'} className='mt-5 flex items-center border border-black gap-3 font-medium px-3 py-2 bg-white shadow-[-5px_5px_0px_#000000]'>
                        <Image src={assets.blog_icon} alt="categories" width={28} className='w-[130px] sm:w-auto' />
                        <p className="hidden sm:block text-xl font-bold">Categories</p>
                    </Link>
